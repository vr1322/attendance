...
public class ot_emp_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ot_emp_list);
...
// Ensure 'listData' is initialized as a List<Attendance>
        ...
        // Back Button
        backButton.setOnClickListener(view -> startActivity(new Intent(ot_emp_list.this, AllocateOtPage.class)));
        emp_listTxt.setOnClickListener(view -> startActivity(new Intent(ot_emp_list.this, AllocateOtPage.class)));
        // Search
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                response -> {
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(ot_emp_list.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                    }
                },
                error -> Toast.makeText(ot_emp_list.this, "Error fetching data", Toast.LENGTH_SHORT).show());
    ...
    private void selectSingleEmployee(Employee employee) {
        ...
        Intent intent = new Intent(ot_emp_list.this, AllocateOvertimeActivity.class);
